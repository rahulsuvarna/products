...
public class ProductServiceTest {
    ...
    public void getProductsForCategory_NonFound() {
        ...
        final TestObserver<List<Product>> testObserver = productService.getProductsForCategory(
                "12345678",
                "ShowWasNow ",
                true
        ).test();
    ...
    public void getProductsForCategory_OneFound() {
        List<JLProduct> list = new ArrayList<>(Collections.singletonList(JLProduct.builder()
                .productId("1234")
                .title("Some Title")
                .price(Price.builder()
                        .was(BigDecimal.TEN)
        ...
        productService.getProductsForCategory("12345678", "ShowWasNow ", true)
                .test()
                .assertNoErrors()
                .assertValue(check(l -> Observable.fromIterable(l)
